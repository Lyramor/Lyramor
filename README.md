...
<svg width="100%" height="220" viewBox="0 0 900 220" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- overlay -->
  <rect width="900" height="220" fill="rgba(13,15,30,0.52)"/>
  <!-- centered text -->
  <text x="450" y="88" text-anchor="middle" font-family="'Fira Code',monospace" font-size="11" fill="#7dcfff" letter-spacing="8" style="animation:fadein 1s 0.3s both;">// software engineer</text>
  <text x="450" y="132" text-anchor="middle" font-family="'Fira Code',monospace" font-size="34" font-weight="700" fill="#c0caf5" letter-spacing="3" style="animation:fadein 1s 0.7s both;">Software <tspan fill="#7aa2f7">Engineer</tspan></text>
  <text x="450" y="164" text-anchor="middle" font-family="'Fira Code',monospace" font-size="11" fill="#565f89" letter-spacing="3" style="animation:fadein 1s 1.1s both;">React · Next.js · Vue · Laravel · Express · Flutter</text>
</svg>
